...
How to:
#: = Total Number of Models in Attacking Unit
A: = Number of Attacks by Attacking model
BS: = Ballistic Skill (Can also be Weapon Skill)
S: = Strength
AP: = Armor Pen
D: = Damage
T: = Toughness of Defending Model
